...
def scrapeFacebookPageFeedStatus(page_id, access_token, since_date, until_date):
    ...
    while has_next_page:
        ...
        ret = request_until_succeed(url)
        if ret.status_code == 200:
            statuses = json.loads(ret.content)
        else:
            print("\n", ret.status_code, ret.url, ret.content, "\n")
            return False
        ...
        for status in statuses['data']:
            ...
            if 'reactions' in status:
                ...
                status_dict = {
                    ...
                    "status_message": status_data[1],
                    "link_name": status_data[2],
                    "status_type": status_data[3],
                    "status_link": status_data[4],
                    "status_published": status_data[5],
                    "num_reactions": status_data[6],
                    "num_comments": status_data[7],
                    "num_shares": status_data[8],
                    "num_likes": reactions_data[0],
                    "num_loves": reactions_data[1],
                    "num_wows": reactions_data[2],
                    "num_hahas": reactions_data[3],
                    "num_sads": reactions_data[4],
                    "num_angrys": reactions_data[5],
